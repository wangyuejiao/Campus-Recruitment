            ...
            <div>
                {this.state.delivery.map((item,index)=>(
                             ...
                             <Col span={2} style={{marginLeft:'2%'}}><img
                              ...
                              /></Col>
                             <Col span={2} style={{fontWeight:'bold',fontSize:'16px',color:'#3c9f8a'}}>{item.company_name}</Col>
                             <Col span={2}></Col>
                             <Col span={4}>{item.post_name}</Col>
                             <Col span={4} style={{marginLeft:'4%'}}>{item.date}</Col>
                             <Col span={4} style={{marginLeft:'3%',marginRight:'2%'}}>{item.wages_min}k-{item.wages_max}k</Col>
                             {
                                 item.status==1?(
